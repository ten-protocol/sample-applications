...
contract ImageGuessGame {
    ...
    function getChallengePublicInfo(uint256 challengeId) public view returns (string memory, bool, bool, uint256) {
        Challenge storage challenge = challenges[challengeId];
        return (challenge.publicImageURL, challenge.isActive, challenge.isRevealed, challenge.prizePool);
    }
    ...
    function isInside(uint256[2] memory topLeft, uint256[2] memory bottomRight, uint256[2] memory point) private pure returns (bool) {
