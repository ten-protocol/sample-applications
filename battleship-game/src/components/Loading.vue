...
async function loadGame() {
  ...
  const progressBar = document.querySelector('.loading__bar span') as HTMLSpanElement | null
  ...
  try {
    ...
    await animateProgressBar('5%', 1000)
    await animateProgressBar('20%', 500)
    await animateProgressBar('70%', 500)
    await animateProgressBar('100%', 500)
