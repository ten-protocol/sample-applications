...
export default class Web3Service {
  ...
  async getAllShipPositions() {
    ...
    try {
      ...
      messageStore.addMessage(
        "Failed to get ship properties - " + error.reason + " ...",
      );
    }
  }
  ...
  async getShipAtPosition(x, y) {
    ...
    try {
      ...
      messageStore.addMessage(
        "Failed to get ship at position - " + error.reason + " ...",
      );
    }
  }
  ...
  async isCellHit(x, y) {
    ...
    try {
      ...
      addToMessageStore(
        "Failed to get cell hit status - " + error.reason + " ...",
      );
    }
  }
  ...
  async isShipSunk(shipIndex) {
    ...
    try {
      ...
      addToMessageStore(
        "Failed to get ship sunk status - " + error.reason + " ...",
      );
    }
  }
